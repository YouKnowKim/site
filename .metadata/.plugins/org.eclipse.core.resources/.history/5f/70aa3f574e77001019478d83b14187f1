...
import com.yonseidairy.site.dao.ColdChainRequest;
...
public class PublicUserController {
	...
	// 주소 기반 대리점 정보 조회 API
	@GetMapping("/getCustnoList")
	public List<InfoByCustnoDao> getCustnoList() {
		return addressService.getCustnoList();
    }
	
	@PostMapping("/saveColdChainData")
	public ResponseEntity<?> saveColdChainData(@RequestBody ColdChainRequest request){
		
		HashMap<String, String> result = new HashMap<>();
		
		addressService.saveColdChainData(request.getData());
